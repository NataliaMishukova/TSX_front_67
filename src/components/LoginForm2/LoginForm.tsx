...
function LoginForm() {
  ...
  const formik = useFormik({//вызываем функцию useFormik, которая требует аргументы
    initialValues: {
    ...
    <LoginFormContainer onSubmit={formik.handleSubmit}>
      ...
      <InputsContainer>
        ...
        <Input
          ...
          type="password"   //если убрать  type="emeil" то отключиться стандартная браузерная валидация
